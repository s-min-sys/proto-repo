...
goog.exportSymbol('proto.user.api.GoogleAuthFlag', null, global);
...
proto.user.api.UserInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = /** @type {!proto.user.api.GoogleAuthFlag} */ (reader.readEnum());
      msg.setFlagGa(value);
      break;
    default:
      reader.skipField();
...
/**
 * optional GoogleAuthFlag flag_ga = 6;
 * @return {!proto.user.api.GoogleAuthFlag}
 */
proto.user.api.UserInfo.prototype.getFlagGa = function() {
  return /** @type {!proto.user.api.GoogleAuthFlag} */ (jspb.Message.getFieldWithDefault(this, 6, 0));
};


/**
 * @param {!proto.user.api.GoogleAuthFlag} value
 * @return {!proto.user.api.UserInfo} returns this
 */
 ...
 * @const
 */
proto.user.api.GetUserListResponse.repeatedFields_ = [2];
...
proto.user.api.GetUserListResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    cnt: jspb.Message.getFieldWithDefault(msg, 1, 0),
...
proto.user.api.GetUserListResponse.prototype.getUsersList = function() {
  return /** @type{!Array<!proto.user.api.UserListItem>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.user.api.UserListItem, 2));
};
...
proto.user.api.GetUserListResponse.prototype.addUsers = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.user.api.UserListItem, opt_index);
};
